...
public record QuestionDTO(UUID id,
                @NotNull(message = "Creation date cannot be null") @PastOrPresent(message = "Creation date cannot be in the future") LocalDateTime creationDate,

                @NotBlank(message = "Question text cannot be blank") @Size(min = 10, max = 500, message = "Question text must be between 10 and 500 characters") String questionText,
